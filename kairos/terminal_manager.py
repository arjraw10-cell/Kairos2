...
class TerminalManager:
    ...
    def execute_command(self, terminal_id: int, command: str, timeout: Optional[int] = None, is_background: Optional[bool] = None) -> Tuple[bool, str]:
        ...
        Note you must create a terminal to run a command in it. 
        Also note if you are running in a blocking terminal, timeout is required
        """
        with self._lock:
        ...
        if is_background is None and timeout is None:
            return False, "Timeout is required for blocking terminals"
